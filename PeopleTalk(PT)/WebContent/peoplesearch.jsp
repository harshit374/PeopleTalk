...
<html lang="en">
  ...
  <%
  	...
  	if(userDetails != null){
  		ArrayList<HashMap<String, Object>> allUserDetails = (ArrayList<HashMap<String, Object>>) session.getAttribute("allUserDetails");
  ...
  %>
	...
	<br>
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-3">
					<img src="GetPhoto?email=<%=peopleDetail.get("email")%>" width="145" height="140">
				</div>
				<div class="col-lg-7">
				...
				<form action="talk.jsp" class="form-horizontal">
					<div class="col-lg-2">
						...
						<br>
						<br>
							<input type="hidden" value ="<%= peopleDetail.get("email") %>" name="temail"/>
