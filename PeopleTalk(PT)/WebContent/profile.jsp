	...
	<br>
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="col-lg-4">
						<img src="GetPhoto?email=<%=userDetails.get("email")%>" width="145" height="140">
					</div>
					<div class="col-lg-6">
				...
				<div class="col-lg-6">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<form action="SearchPeople" class="form-horizontal">
								<div class="form-group">
									<label for="state" class="col-lg-3 control-label">State:</label>
									<div class="col-lg-9">
										<select name="state" class="form-control" id="listBox" onchange='selct_district(this.value)' required="required">
